export const knowledgeData = [
    {
        ...
        content: `
            ...
            <p>Secara sederhana, UI/UX adalah dua elemen inti dalam desain produk digital yang saling melengkapi. UI (User Interface) berkaitan dengan tampilan visual, sedangkan UX (User Experience) berfokus pada pengalaman pengguna secara keseluruhan. Meski sering disebut bersamaan, keduanya memiliki peran yang berbeda namun sama-sama krusial.</p>

            <iframe width="560" height="315" src="https://www.youtube.com/embed/RuxJslog_iE?si=Eyhocsg-Y64tUox8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

            <h2>Perbedaan Mendasar UI dan UX</h2>
            <p>Banyak orang mengira UI dan UX adalah hal yang sama, padahal keduanya memiliki fokus yang berbeda. Analogi yang sering digunakan adalah sebuah rumah. UX adalah fondasi, struktur, dan fungsionalitas rumah tersebut—apakah kamar tidurnya nyaman? Apakah dapurnya mudah diakses? Sementara itu, UI adalah cat dinding, dekorasi, furnitur, dan estetika yang membuat rumah tersebut terlihat indah.</p>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>Fokus Utama</td>
                            <td>Visual, tata letak, dan estetika produk.</td>
                            <td>Logika, interaksi, dan kemudahan penggunaan.</td>
                        </tr>
                        <tr>
                            <td>Tujuan</td>
                            <td>Membuat produk terlihat menarik dan konsisten.</td>
                            <td>Membuat produk berguna, mudah digunakan, dan menyenangkan.</td>
                        </tr>
                        <tr>
                            <td>Elemen</td>
                            <td>Warna, tipografi, gambar, icon, spacing.</td>
                            <td>User flow, wireframe, sitemap, persona pengguna.</td>
                        </tr>
                    </tbody>
                </table>
            </div>

            <h2>Tahapan Proses Design UI/UX</h2>
            ...
            <p>Investasi pada desain UI/UX bukan sekadar agar aplikasi terlihat "cantik". Ada dampak bisnis yang nyata:</p>
            
            <blockquote>"Good design is good business." — Thomas Watson Jr.</blockquote>
            
            <p>Produk dengan UX yang baik dapat meningkatkan <strong>Conversion Rate</strong>, mengurangi biaya <strong>Customer Support</strong> karena pengguna tidak bingung, dan meningkatkan <strong>Customer Retention</strong>. Pengguna cenderung kembali ke aplikasi yang mereka rasa nyaman dan mudah digunakan.</p>
    ...
    {
        id: 2,
        title: "Strategi Microinteractions untuk Meningkatkan Engagement",
        slug: "strategi-microinteractions",
        category: "Interaction Design",
        date: "18 April 2025",
        author: { name: "Capt Budiman", initial: "B", role: "Senior UI/UX Designer" },
        image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&q=80&w=1200",
        excerpt: "Microinteractions adalah momen-momen kecil yang memiliki dampak besar dalam menciptakan emotional connection dan meningkatkan keterlibatan pengguna.",
        content: `
            <p><strong>Microinteractions</strong> - Seringkali, perbedaan antara produk yang 'cukup oke' dan produk yang 'luar biasa' terletak pada detail kecil. Salah satu detail tersebut adalah <em>microinteractions</em>. Pernahkah Anda merasakan kepuasan tersendiri saat menarik layar ke bawah untuk refresh (pull-to-refresh) atau saat menekan tombol like yang meletup dengan animasi halus? Itulah kekuatan microinteractions.</p>
            
            <p>Microinteractions adalah momen-momen kecil di mana pengguna dan antarmuka berinteraksi. Meskipun kecil, mereka memiliki dampak besar dalam menciptakan <em>emotional connection</em> dan meningkatkan keterlibatan (engagement) pengguna.</p>
            ...
            <ul>
                <li><strong>Toggle Switch:</strong> Animasi halus saat menggeser tombol on/off memberikan kepastian status sistem.</li>
                <li><strong>Upload Progress:</strong> Bar loading yang bergerak memberikan estimasi waktu dan mencegah frustrasi.</li>
                <li><strong>Input Validation:</strong> Pesan error yang muncul <em>real-time</em> saat mengetik password salah, atau centang hijau saat benar.</li>
            </ul>

            <p>Ingatlah, microinteractions yang baik haruslah <em>invisible</em>. Pengguna seharusnya tidak merasa terganggu, namun justru merasa terbantu. "The details are not the details. They make the design." - Charles Eames.</p>
        `
    },
    {
        id: 3,
        ...
        content: `
            ...
            <p>Design System bukan sekadar <em>Style Guide</em> atau kumpulan komponen UI di Figma. Ia adalah 'single source of truth' yang menjembatani desain dan pengembangan code, memastikan produk dibangun dengan standar yang sama.</p>
            ...
            <ol>
                <li><strong>Atoms:</strong> Elemen terkecil yang tidak bisa dipecah lagi. Contoh: Warna, Font, Icon, Tombol dasar.</li>
                <li><strong>Molecules:</strong> Gabungan atom yang membentuk fungsi sederhana. Contoh: Form pencarian (Input + Button icon).</li>
                <li><strong>Organisms:</strong> Komponen kompleks gabungan molekul. Contoh: Header website (Logo + Menu + Search bar).</li>
                <li><strong>Templates:</strong> Struktur halaman tanpa konten asli (wireframe layout).</li>
                <li><strong>Pages:</strong> Template yang sudah diisi konten riil.</li>
            </ol>

            <p>Membangun Design System adalah perjalanan maraton, bukan lari sprint. Mulailah dari yang kecil, dokumentasikan dengan baik, dan terus iterasi bersama tim developer.</p>
        `
    },
    {
        id: 4,
        title: "Panduan UX Research: Metode Cepat B2B",
        slug: "ux-research-b2b",
        category: "UX Research",
        date: "01 Februari 2025",
        author: { name: "Nina Putri", initial: "N", role: "UX Researcher" },
        image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=1200",
        excerpt: "Riset pengguna untuk produk B2B memiliki tantangan unik. Bagaimana cara melakukan riset yang efektif namun tetap efisien waktu?",
        content: `
            <p>Riset pengguna untuk produk B2B (Business-to-Business) memiliki tantangan unik dibandingkan B2C. Penggunanya spesifik, sulit dijangkau, dan seringkali keputusan pembelian bukan di tangan pengguna akhir. Namun, tanpa riset, produk Anda hanya akan menjadi asumsi belaka.</p>
            
            <p>Bagaimana cara melakukan riset yang efektif namun tetap efisien waktu (agile) di lingkungan B2B?</p>

            <h2>Tantangan Riset B2B</h2>
            <ul>
                <li>Sulit merekrut partisipan (mereka sibuk bekerja).</li>
                <li>Domain knowledge yang kompleks (misal: aplikasi medis atau finansial).</li>
                <li>Pengguna vs Pembeli seringkali berbeda orang.</li>
            </ul>
    ...
    {
        id: 5,
        title: "10 Trik Prototyping Cepat untuk Kolaborasi",
        slug: "trik-prototyping-cepat",
        ...
        content: `
            ...
            <p>Bagaimana cara membuat prototype dengan cepat namun tetap komunikatif untuk tim developer dan stakeholder? Berikut tipsnya.</p>
