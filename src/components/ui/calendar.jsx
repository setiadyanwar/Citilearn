        ...
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    ...
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center hover:bg-slate-100 hover:text-slate-900"
                ),
                day_range_end: "day-range-end",
                day_selected:
                    "bg-slate-900 text-white hover:bg-slate-800 hover:text-slate-50 focus:bg-slate-900 focus:text-white",
