    ...
    const getStatusBadge = (status) => {
        ...
        switch (status) {
            ...
            case COURSE_STATUS.ON_PROGRESS:
                return (
                    <Badge variant="warning" size="sm" className="gap-1.5 shadow-sm">
            ...
            default:
                return (
                    <Badge variant="secondary" size="sm" className="gap-1.5 shadow-sm">
            ...
            <Link to={`/course/${course.id}`} className="flex flex-col h-full">
                ...
                <div className={`${compact ? 'p-4' : 'p-6'} flex-1 flex flex-col`}>
                    ...
                    {compact ? (
                        ...
                        <p className="text-sm text-gray-500 dark:text-slate-400 mb-6 line-clamp-2 leading-relaxed font-medium">
                            {course.description}
                        </p>
                    )}
