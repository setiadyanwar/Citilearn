    ...
    if (!isFinalQuiz) {
        return (
            <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                    <h3 className="text-base font-black text-citilink-dark dark:text-white leading-tight">Knowledge Check</h3>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-0.5">
                            ...
                            <span className="text-smxs font-bold text-slate-300 uppercase tracking-wider">Question {currentQuestionIndex + 1} of {totalQuestions}</span>
                        </div>
                        <h3 className="text-base font-black text-citilink-dark dark:text-white">Module Certification</h3>
                    </div>
                </div>
                <div className="text-right">
                    <div className="text-sml font-black text-citilink-dark dark:text-white leading-none">
                        {progress}%
                    </div>
                    <div className="text-smxs font-black text-slate-400 uppercase tracking-wider mt-1">Progress</div>
                </div>
            </div>
