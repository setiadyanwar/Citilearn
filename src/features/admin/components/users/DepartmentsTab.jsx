        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            ...
            >
                <div className="w-10 h-10 rounded-xl bg-slate-100 group-hover:bg-primary/10 flex items-center justify-center transition-colors">
                    <Plus size={20} className="text-tertiary group-hover:text-primary transition-colors" />
                </div>
                <p className="text-sm font-bold text-tertiary group-hover:text-primary transition-colors">
                    Add Department
                </p>
            </button>
            ...
            {filtered.map(dept => (
                ...
                >
                    <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-tertiary font-medium mt-0.5">{dept.memberCount} members</p>
                            </div>
                        </div>
                        <ActionMenu actions={[
                    ...
                    <p className="text-xs font-medium text-secondary mb-4 leading-relaxed line-clamp-2">
                        {dept.description}
                    </p>

                    <div className="flex items-center justify-between pt-3 border-t border-slate-50">
                        <span className="text-xs font-medium text-tertiary flex items-center gap-1.5">
